...
//           <label className="block text-sm text-[#4A403A] mb-2">Участники</label>

//           <div ref={divShareRef} className="flex flex-wrap gap-2 items-center">
...
//           <div>
//             {/* Поле дата начала */}
//             <label className="block text-sm text-[#4A403A] mb-2">Начало</label>
...
//                 )}
//               </label>
//               <label htmlFor="fullDay" className="text-sm text-[#4A403A] ml-2">
//                 Весь день
//               </label>
//             </div>
//           </div>
...
//                 )}
//               </label>
//               <label htmlFor="noColor" className="text-sm text-[#4A403A] ml-2">
//                 Без цвета
//               </label>
//             </div>
//           </div>
